      ...
      <div className="bg-surface-100 border border-accent-red/30 rounded-sm w-full max-w-md shadow-lg" onClick={e => e.stopPropagation()}>
        ...
        <div className="px-5 py-4">
          ...
          <input
            ...
            className="w-full bg-surface-200 border border-accent-red/30 rounded-sm px-3 py-2 text-sm text-gray-100 font-mono focus:outline-none focus:border-accent-red focus:transition-all"
            autoFocus

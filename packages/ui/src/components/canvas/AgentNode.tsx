    ...
    `}>
      ...
      <div className="flex items-center gap-2 min-w-0">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="text-[10px] text-accent-blue/70 font-mono uppercase truncate">{(data as any).agent ?? 'agent'}</div>
        </div>
      </div>
      {(() => {
        ...
        return (
          <div className="mt-1.5 flex flex-wrap gap-1">
            ...
            {hidden > 0 && (
              <span
                className="text-[9px] bg-accent-blue/10 text-accent-blue/70 px-1 rounded-sm font-mono"

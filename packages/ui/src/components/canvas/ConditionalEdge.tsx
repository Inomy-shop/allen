      ...
      {label && (
        ...
        >
          <div className="flex items-center justify-center">
            <span
              title={String(label)}
              className="bg-surface-200 border border-app text-theme-secondary text-[9px] px-2 py-0.5 rounded-sm whitespace-nowrap max-w-[110px] truncate font-mono cursor-help hover:bg-surface-300 hover:border-border transition-colors"
            >
              {label as string}
            </span>
          </div>

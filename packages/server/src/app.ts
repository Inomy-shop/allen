...
import { createRepoKnowledgeGraphIndexIfChangedAction } from './services/repo-knowledge-graph.service.js';
...
async function main(): Promise<void> {
  ...
  // Public first-run status. This must be available before login so a fresh
  // open-source instance can route to UI admin bootstrap instead of /login.

...
import { withArtifactsGuidance, withNonInteractiveGuidance, withPaginationGuidance } from '@allen/engine';
  ...
  private async runScan(repoId: string, repoPath: string, repoName: string): Promise<void> {
    ...
    try {
      ...
      const sdkOptions: Record<string, unknown> = {
        ...
        cwd: repoPath,
        customSystemPrompt: withPaginationGuidance(withNonInteractiveGuidance(withArtifactsGuidance(agent.system as string))),
        abortController,
      };

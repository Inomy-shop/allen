...
const NAV = [
  { group: '', items: [
    { id: 'mywork',   label: 'my work',        icon: 'sparkle',  badge: '5' },
    { id: 'inbox',    label: 'inbox',          icon: 'intervene', badge: '8' },
    { id: 'threads',  label: 'threads',        icon: 'chat',     badge: '' },
  ]},
  { group: 'Sources', items: [
    { id: 'linear',     label: 'tickets',        icon: 'linear',    badge: '200' },
    { id: 'pulls',      label: 'pull requests',  icon: 'pr',        badge: '21' },
    { id: 'workspaces', label: 'workspaces',     icon: 'workspace', badge: '8' },
  ]},
  { group: 'Org', items: [
    { id: 'library',   label: 'library',       icon: 'agents',    badge: '' },
    { id: 'activity',  label: 'activity',      icon: 'play',      badge: '14' },
    { id: 'analytics', label: 'analytics',     icon: 'analytics', badge: '' },
    { id: 'learnings', label: 'learnings',     icon: 'lightning', badge: '7' },
  ]},
...
const ROUTE_TITLES = {
  ...
  learnings: 'Learnings',
  library: 'Library',
  // legacy alias — old "orgsettings" route still resolves
  orgsettings: 'Library',
  settings: 'Settings',
  // legacy still routable from inside library
  workflows: 'Workflows',
  agents: 'Agents & teams',
  repos: 'Repositories',
